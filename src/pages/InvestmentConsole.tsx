        ...
        <InteractMasterLayout>
            <div className="max-w-[1600px] mx-auto px-6 py-6 font-sans">
                ...
                <div className="flex items-center gap-2 text-sm text-muted-foreground mb-6">
                    ...
                    <span>&gt;</span>
                    <span className="font-medium text-foreground">Investment Console</span>
                </div>

                {/* Top Action Buttons - Only Discover Partnerships */}
                <div className="mb-6">
                    <div className="bg-white p-4 rounded-lg border border-slate-200 hover:shadow-sm cursor-pointer transition-all flex items-center justify-between group max-w-md">
                        <div className="flex items-center gap-3">
                            <Briefcase className="h-5 w-5 text-slate-600" />
                            <span className="font-semibold text-slate-900">Discover Partnerships</span>
                        </div>
...
export default InvestmentConsole;
